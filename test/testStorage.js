...
describe.only("Storage functionality", async() => {
    ...
    beforeEach(async() => { 
        ...
        fractionAddress = await Storage.getFractionAddressFromNft(nftContract.address, iterator);
        const FractionContract = await ethers.getContractFactory("baseFractionToken");
